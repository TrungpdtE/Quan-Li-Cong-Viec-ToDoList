...
### Do đề bài yêu cầu làm theo ngôn ngữ và framework thạo nhất, nên em quyết định lựa chọn FastApi Python để hoàn thành kịp hạn nộp. Nếu có thêm thời gian để học và nghiên cứu về spring java thì em sẽ tiến hành. Đang thử nghiệm docker
